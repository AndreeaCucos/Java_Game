...
{
        // canvas se adauga in frame(ca untablou inrama)
    ...
    private int     wndHeight;      /*!< inaltimea ferestrei in pixeli*/
        ...
        // elementele grafice se deseneaza pe canvas ca pe un tablou
    ...
    */
    public Canvas GetCanvas() // ne permita sa accesam canvas din alte clase
    {
        return canvas;
    }
