...
public class Game implements Runnable
{
    ...
    ///Available states
    public State gameLost;              /*!< Referinta catre starea de joc pierdut.*/
    public State level2;                /*!< Referinta catre nivelul2.*/
    public State gameWon;               /*!< Referinta catre starea de joc castigat.*/
    public State rulesState;            /*!< Referinta catre reguli.*/
    ...
    private MouseManager mouseManager;  /*!< Referinta catre obiectul care gestioneaza intrarile din partea utlizatorului prin mouse.*/
    ...
    */
    ...
    private void InitGame() throws IOException
    {
        ...
        gameLost = new GameLost(refLink);
        gameWon = new GameWonState(refLink);
        rulesState = new RulesState(refLink);
        level2 = new Level2(refLink);
        ...
        mouseManager.setRefLink(refLink);
    }
    ...
    */
    public void run()
    {
        ...
        while (runState)
        {
            ...
            // se apeleaza metoda stop in cazul in care jocul nostru nu se opreste
        StopGame();
    }
    ...
    */
    ...
    {
        if(!runState)   // daca jocul nu ruleaza il proneste
        {
    ...
    {
        if(runState) // daca jocul ruleaza se intrerupe
        {
    ...
    private void Draw()
    {
        ...
        if(bs == null)
        {
            ...
            try
            {
                ...
                wnd.GetCanvas().createBufferStrategy(3); // cream un BufferStrategy care are 3 bufferes
                return;
            }
            catch (Exception e)
            {
        ...
        g = bs.getDrawGraphics();
            // START DRAW
            // in JAVA pixel 0,0 e in stanga sus a ecranului
            // Se sterge ce era
